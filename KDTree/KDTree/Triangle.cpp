...
Triangle::Triangle() :
    ...
    SystemManager::TriangleSystem.AddComponent(this);
}
Triangle::~Triangle()
{
    SystemManager::TriangleSystem.RemoveComponent(this);
}

void Triangle::SetPoints(glm::vec3 a, glm::vec3 b, glm::vec3 c) {
    _vertices[0] = a.x;
    _vertices[1] = a.y;
    _vertices[2] = a.z;
    _vertices[3] = b.x;
